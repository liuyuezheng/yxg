...
use app\refund\model\AssessmentPrice;
use app\refund\model\Coupon;
use app\refund\model\ExpectBrokerage;
use app\refund\model\Goods;
use app\refund\model\MyCoupon;
use app\refund\model\Orders;
use app\refund\model\OrdersDetail;
use app\refund\model\PayDetail;
use app\refund\model\Refund;
...
//        try{
            foreach ($ids as $k){
                $res=$refund->where('id',$k)->field('refund_status,type,refund_status')->find();
