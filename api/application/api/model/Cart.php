...
class Cart extends Model
{
    ...
    * 
    */
   public static function add_cart($user_id = 0,$goods_id = 0,$attr_id = 0,$goods_specification = '',$goods_price = 0,$count=0,$type = 0){
       $where = [
            'user_id'=>$user_id,
            'goods_id'=>$goods_id,
            'attr_id'=>$attr_id,
       ...
       if($arr){
            if($count < $attr['sell_num']){
                ...
                return 4;
            }else if($count > $goods['limit_num'] && $goods['limit_num'] != 0){
                return 5;
            }else{
              if($type == 0){
                 $list = [
              ...
              if($list['count'] > $goods['limit_num']){
                   $list = [
                     'count'=>$goods['limit_num'],
                  ];
              }
  ...
  public static function cart_list($id = 0,$type = 0){
      ...
      $field = [
          ...
          ygap.sell_num as min,yg.limit_num'
      ];
      if($type == 0){
          $where = [
             'yc.user_id'=>$id,
