...
class My extends Controller{
     ...
     public function personalinfo($id = 0){
       ...
       * 
       */
      public  function integral_detail($id = 0){
       ...
       public function withdraw_deposit(){
           ...
           if($res == 1){
              ...
              return json_encode(['code'=>4,'msg'=>'佣金余额不足！']);
           }else if($res == 5){
              return json_encode(['code'=>5,'msg'=>'请输入正确金额格式！']);
           }
       ...
       public function withdraw_cancel($id = 0){
           ...
           if($res == 1){
              ...
              return json_encode(['code'=>3,'msg'=>'已提现成功！']);
           }else if($res == 4){
              return json_encode(['code'=>4,'msg'=>'该提现被拒绝！']);
           }
       }
       /**
        *用户提现进度
     ...
     * 
     */
     public function distributor_detail_list($id = 0,$page = 1){
         $data = my_model::distributor_detail_list($id,$page);
         if($data){
