<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"F:\ayxg\public/../application/index\view\adjust\index.html";i:1552647379;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    财务调整日志&nbsp;&nbsp;<img style="width: 20px" onclick="history.go(0)" src="/static/hplus/img/123.jpg">
                </div>
                <div class="ibox-content">
                    <div class="input-group" style=" width: 100%;">
                        <select  style="width: 19%;margin-left: 16px"  id="pay_type" name="order_type">
                            <?php if($types == 2): ?>
                            <option value="2"  selected="selected" >余额</option>
                            <option value=" " >全部</option>
                            <option value="1" >佣金</option>
                            <?php elseif($types == 1): ?>
                            <option value="1" selected="selected" >佣金</option>
                            <option value=" " >全部</option>
                        ...
                        <input type="text" style="width: 25%;margin-left: 134px;" id="nameorder"  placeholder="手机号/用户编号">
                        <?php else: ?>
                        <input type="text" style="width: 25%;margin-left: 134px;" id="nameorder"  placeholder="手机号/用户编号" value="<?php echo $nameorder; ?>">
                        <?php endif; ?>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr style="text-align: center;">
                            ...
                            <th style="text-align: center;">调整类型</th>
                        ...
                        <tr class="gradeX">
                            ...
                            <td>￥<?php echo $v['money']; ?>
                            <td>
                            <?php if($v['status'] == '0'): ?>余额<?php endif; if($v['status'] == '1'): ?>佣金<?php endif; ?>
                            </td>
...
//        var time_type = $("#time_type option:selected").val();
        ...
        if(time==''){
            window.location.href = "<?php echo url('adjust/index'); ?>?type="+pay_type+"&time="+time+"&nameorder="+nameorder;
        }else{
            if(reg.test(time)){
                window.location.href = "<?php echo url('adjust/index'); ?>?type="+pay_type+"&time="+time+"&nameorder="+nameorder;
            }else{
