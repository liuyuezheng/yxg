<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"F:\ayxg\public/../application/refund\view\refunds\refuse.html";i:1552889865;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<div style="margin: 25px 82px;">
   <textarea style="    width: 80%;
    height: 75%;" placeholder="拒绝原因" id="con"></textarea>
</div>
<a class="btn btn-primary btn-rounded" style=" border-radius: 4px;margin-left: 96px;"   onclick="update_slidestatus(this)" data-status="<?php echo $status; ?>" data-id="<?php echo $id; ?>">确定</a>
...
////                layer.close(index);
                $.ajax({
                    url: '<?php echo url("refunds/uptstatus"); ?>',
                    data: {
                        id:id,status:status,content:con
                    },
                    dataType: "json",
                    type: "post",
