<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"F:\ayxg\public/../application/index\view\goodslist\editsale.html";i:1552814316;}*/ ?>
<!DOCTYPE html>
...
<div id="content-wrap">
    ...
    <div id="content-left" class="demo">
        ...
        <form action="" class="form-horizontal" name="form1">
            <input type="hidden" value="<?php echo $info['id']; ?>" name="pic" id="goods_id">
            <div class="ibox float-e-margins" style="margin-top: 40px;">


                <div class="form-group" style="display: inline-block">
                    <label class="col-sm-2 control-label">销量:</label>
                    <input type="text"  class="form-control"  id="sales" style="margin-left: 102px" placeholder="请输入销量"  value="<?php echo $info['sales']; ?>" oninput="value=value.replace(/[^\d]/g,'')">
                </div>
...
//        })
        ...
        var sales=$("#sales").val();
        var did=$("#goods_id").val();
            $.ajax({
                url: '<?php echo url("goodslist/editsalenum"); ?>',
                type: "post",
                data: {
                    sales:sales,
                    did:did
