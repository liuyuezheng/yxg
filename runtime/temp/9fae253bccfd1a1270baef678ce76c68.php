<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"F:\ayxg\public/../application/index\view\general\details.html";i:1552647378;}*/ ?>
<!DOCTYPE html>
<html>
            ...
            <div class="ibox float-e-margins">
                ...
                <table class="table table-striped table-bordered table-hover dataTables-example">
                    ...
                    <tr class="gradeX">
                        ...
                        <td><?php if(empty($v['orders_num']) || (($v['orders_num'] instanceof \think\Collection || $v['orders_num'] instanceof \think\Paginator ) && $v['orders_num']->isEmpty())): ?><!--$details['goods_name'];
            $data[$k]['orders_num']=$orders['orders_num'];-->
                           无
                            <?php else: ?>
                            <?php echo $v['orders_num']; endif; ?></td>
                        <td><?php if(empty($v['goods_name']) || (($v['goods_name'] instanceof \think\Collection || $v['goods_name'] instanceof \think\Paginator ) && $v['goods_name']->isEmpty())): ?><!--$details['goods_name'];
            $data[$k]['orders_num']=$orders['orders_num'];-->
                            无
                            <?php else: ?>
                            <?php echo $v['goods_name']; endif; ?></td>
...
<script>
    ...
    function member_out(member_out) {
        ...
        window.location.href = "<?php echo url('general/excel1'); ?>?id="+id;
    }
    //关键字搜索
    function search(){
...
//        var time = $("#test5").val();
        var nameorder = $("#nameorder").val();
        window.location.href = "<?php echo url('monitor/index'); ?>?nameorder="+nameorder;
    }
