<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:61:"F:\ayxg\public/../application/index\view\manager\details.html";i:1552474760;}*/ ?>
<!DOCTYPE html>
<html>
...
<script>
    ...
    function member_out(member_out) {
        ...
        window.location.href = "<?php echo url('manager/excel1'); ?>?id="+id;
    }
    //实现全选与反选
