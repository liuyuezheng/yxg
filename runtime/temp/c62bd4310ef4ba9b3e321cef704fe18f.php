<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\ayxg\public/../application/refund\view\index\welcome.html";i:1552877415;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body class="gray-bg">
		...
		&lt;!&ndash; 					<div class="stat-percent font-bold text-navy">98% <i class="fa fa-bolt"></i></div> &ndash;&gt;
						</div>
						<div style="float: left;background-color: #FFF;    padding: 15px 20px 20px;">
							<h5>已支出佣金（元）</h5>
