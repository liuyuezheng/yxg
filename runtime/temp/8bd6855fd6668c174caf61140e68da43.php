<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:60:"F:\ayxg\public/../application/index\view\kitings\reject.html";i:1552469120;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    提现驳回记录&nbsp;&nbsp;<img style="width: 20px" onclick="history.go(0)" src="/static/hplus/img/123.jpg">
                </div>
 ...
 -->
                    <div class="input-group" style=" width: 100%;">
                        ...
                        <a data-toggle="modal" class="btn btn-w-m btn-danger" id="getAllSelectedId2" style="margin-left: 10px" href="form_basic.html#modal-form">提现记录</a>
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr class="gradeX">
                            ...
                            <td>
                                <?php if(empty($v['reason']) || (($v['reason'] instanceof \think\Collection || $v['reason'] instanceof \think\Paginator ) && $v['reason']->isEmpty())): ?>
                                无
                                <?php else: ?>
                                <?php echo $v['reason']; endif; ?>
...
<script>
    ...
    function member_out(member_out) {
        ...
        if(time1==''){
            window.location.href = "<?php echo url('kitings/upexcel2'); ?>?time="+time1+"&nameorder="+nameorder;
        }else{
            if(reg1.test(time1)){
                window.location.href = "<?php echo url('kitings/upexcel2'); ?>?time="+time1+"&nameorder="+nameorder;
            }else{
...
//        var time_type = $("#time_type option:selected").val();
        ...
        if(time==''){
            window.location.href = "<?php echo url('kitings/reject'); ?>?time="+time+"&nameorder="+nameorder;
        }else{
            if(reg.test(time)){
                window.location.href = "<?php echo url('kitings/reject'); ?>?time="+time+"&nameorder="+nameorder;
            }else{
