<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\ayxg\public/../application/index\view\describe\edit.html";i:1552572635;}*/ ?>
<!DOCTYPE html>
...
<div id="content-wrap">
    ...
    <div id="content-left" class="demo">
        <div style="margin-top: 22px;font-size: larger;font-weight:bolder;margin-left: 15px">
            修改轮播图 <span style="color: red">注意：如同时选择内部商品和填写外部链接，默认内部商品为准</span>
        </div>
        <form action="" class="form-horizontal" name="form1">
            <input type="hidden" value="<?php echo $data['id']; ?>" name="pic" id="decribe_id">
            <div class="ibox float-e-margins" style="margin-top: 40px;">
                <div class="form-group">
                    <div class="layui-upload">
                        ...
                        <div class="layui-upload-list" style="padding-left:70px;">
                            <img class="layui-upload-img" src="<?php echo $data['slideshow']; ?>" id="showImg" width="200">
                            <input type="hidden" value="<?php echo $data['slideshow']; ?>" name="pic" id="path">
                        </div>
                ...
                <div class="form-group" style="display: inline-block">
                    ...
                    <input type="text"  class="form-control"  id="describe" style="margin-left: 102px" placeholder="请输入描述"  value="<?php echo $data['describe']; ?>" >
                </div>
                ...
                <?php if($data['goods_id'] != 0): ?>
                <!--goods_number,goods_price-->
                <div style="margin: 10px 0;"><input type="radio" checked name="name" value="<?php echo $data['goods_id']; ?>"> <div style="display: inline-block"><?php echo $data['name']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商品编号：<?php echo $data['goods_number']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;价格：<?php echo $data['goods_price']; ?></div></div>
                <?php endif; ?>
                ...
                <div class="form-group" style="display: inline-block;width: 100%">
                    ...
                    <input type="text" id="link" placeholder="请输入链接" class="form-control" style="margin-left: 102px;width: 25%" value="<?php echo $data['link']; ?>" > &nbsp;&nbsp;<span style="color: red">注意:此为外部链接（小程序中无法使用，公众号可使用）</span>

                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
                    <div class="col-sm-4 col-sm-offset-3" style="height:329px">
                        <button class="btn btn-primary" style="width: 10%;height: 10%" onclick="add_goodsinfo()" type="button">确认修改</button>
...
//                        $('#path').val(res.data.src); // 将上传后的图片路径赋值给隐藏域
    ...
    function search() {
        ...
        if(goods==""){
            ...
            $.ajax({
                url: '<?php echo url("describe/goods2"); ?>',
                type: "post",
                data: {
                    goods:goods,
                    goods_id:goods_id
...
//        })
        ...
        if(goods_id == "" && link == ""){
            ...
            $.ajax({
                url: '<?php echo url("describe/edits"); ?>',
                type: "post",
                data: {
                    pic:pic,
                    describe:describe,
