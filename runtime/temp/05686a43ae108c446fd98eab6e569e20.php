<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\ayxg\public/../application/index\view\general\index.html";i:1552571777;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    总代佣金&nbsp;&nbsp;<img style="width: 20px" onclick="history.go(0)" src="/static/hplus/img/123.jpg">
                </div>
...
<script>
    ...
    function update_sliderefuse(update_sliderefuse){
        ...
        window.open("<?php echo url('general/details'); ?>?id="+id);
    ...
    function member_out(member_out) {
        ...
        window.location.href = "<?php echo url('general/excel'); ?>?nameorder="+nameorder;
    }
    //关键字搜索
    function search(){
...
//        var time = $("#test5").val();
        var nameorder = $("#nameorder").val();
        window.location.href = "<?php echo url('general/index'); ?>?nameorder="+nameorder;
    }
