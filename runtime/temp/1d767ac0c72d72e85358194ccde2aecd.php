<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:59:"F:\ayxg\public/../application/index\view\special\mains.html";i:1550632467;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    success: function(data) {
                        ...
                        if(data==1){
                            layer.msg('操作成功',{icon: 1, shift: 6},function () {
                                window.location.href = "<?php echo url('special/mains'); ?>";
                            });
