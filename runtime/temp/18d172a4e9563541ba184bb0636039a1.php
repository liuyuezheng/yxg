<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:57:"F:\ayxg\public/../application/index\view\users\index.html";i:1552571322;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    普通用户&nbsp;&nbsp;<img style="width: 20px" onclick="history.go(0)" src="/static/hplus/img/123.jpg"></div>
                </div>
            ...
            $this->assign('names','');-->
                    ...
                    <table class="table table-striped table-bordered table-hover dataTables-example">
                        ...
                        <tr style="text-align: center;">
                            ...
                            <th style="text-align: center;">直属董事昵称</th>
                        ...
                        <tr class="gradeX">
                            ...
                            <td><img src="<?php echo $v['head_image']; ?>" width="80px"></td>
                            <td><ul>
                            ...
                            <td ><?php if($v['first_manager'] == 0): ?>
                                无
                                <?php else: ?>
                                <a href="<?php echo url('users/superiordetail'); ?>?id=<?php echo $v['first_manager']; ?>" style="color: green"><?php echo $v['manager_name']; ?></a>
                                <?php endif; ?>
                               </td>
...
<script>
    ...
    function show_detail(show_detail) {
        ...
        window.open( "<?php echo url('users/indexdetail'); ?>?id="+id);
    }
    //修改用户信息
    ...
    function search(){
        ...
        if(nameorder=="" && order_type>0){
            ...
            window.location.href = "<?php echo url('users/index'); ?>?order_type="+order_type+"&nameorder="+nameorder;
        }
    }
    //同意退款 退货
